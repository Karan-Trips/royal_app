...
import 'package:royal_app/features/mileage/screens/mileage_screen.dart';
import 'package:royal_app/features/settings/screens/settings_screen.dart';
import 'package:royal_app/features/tracking/screens/tracking_screen.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        OpenContainer(
                          ...
                          closedBuilder: (ctx, openFn) => _IgnitionButton(
                            onTap: () async {
                          ...
                          openBuilder: (ctx, closeFn) => const TrackingScreen(),
                        ),
      ...
      actions: [
        ...
        IconButton(
          ...
          onPressed: () {
            ...
            Navigator.of(
              context,
            ).push(MaterialPageRoute(builder: (_) => const MileageScreen()));
          },
        ),
        IconButton(
